...
const values = [
  ...
  },
  {
    icon: Clock,
    title: "Agility",
    description: "Fast iteration and rapid deployment without compromising quality.",
  },
  {
    icon: Globe,
    title: "Global Impact",
    description: "Solutions that scale across borders and industries worldwide.",
  },
];
          ...
          <div className="container px-6">
            ...
            >
              <h1 className="font-heading text-4xl md:text-6xl font-bold mb-6">
                About <span className="gradient-text">Deep Data Xperts</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                We're a team of data scientists, ML engineers, and AI strategists obsessed with 
                turning complex data challenges into competitive advantages.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    To democratize AI and empower businesses of all sizes to harness the 
                    transformative power of intelligent systems.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We believe that AI should be accessible, understandable, and impactful. 
                ...
                <div className="glass-card p-8">
                  <div className="grid grid-cols-2 gap-6">
                    {stats.map((stat, index) => (
                      ...
                      >
                        <div className="font-heading text-3xl font-bold text-orange-400/70 mb-1">
                          {stat.value}
                        </div>
              ...
              {values.map((value) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center mb-4">
                    <value.icon className="w-6 h-6 text-red-400/90" />
                  </div>
